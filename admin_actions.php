...
if ($action === 'add_product') {
    ...
    $sql = "INSERT INTO products (name, price, description, image_path, category, is_active, stock) 
                VALUES ('$name', $price, '$description', '$image_path', 'mochi', 1, $stock)";
    ...
    if ($action === 'update_product') {
        ...
        $sql = "UPDATE products 
                SET name = '$name', price = $price, description = '$description', image_path = '$image_path', stock = $stock
                WHERE id = $id";
